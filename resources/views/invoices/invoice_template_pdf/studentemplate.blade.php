...
<head>
	...
	<link rel="stylesheet" href="{{asset('assets/invoice/assets/css/custom.css')}}">
	<link rel="stylesheet" href="{{asset('assets/invoice/assets/css/media-query.css')}}">
</head>
<body>
				...
				<header class="student-header" id="invo_header">
					<div class="student-header-details">
						<div class="student-logo-content width-50">
							<div>
								<a href="student_invoice.html"><img src="{{asset('assets/invoice/images/student/logo.png')}}" alt="logo"></a>
							</div>
							<div class="pt-30">
							...
							<div class="student-header-bg">
								...
								<div class="invo-head-content pt-30">
									...
									<div class="invo-head-wrap invoi-date-wrap">
										...
										<div class="font-md-grey color-white">15/04/2023</div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="invo-car-book-wrap1 pt-40">
							<div class="booking-content-wrap">
								<div class="invo-book-detail detail-col-car1">
									...
									<span class="font-sm ">Jordon Smith</span>
								</div>
								<div class="invo-book-detail detail-col-car1">
									<span class="font-sm-700 color-light-black">Student ID:</span>
									<span class="font-sm">DI923514</span>
								</div>
								<div class="invo-book-detail detail-col-car1">
									<span class="font-sm-700 color-light-black">Term:</span>
									<span class="font-sm">Winter</span>
								</div>
							</div>
							<div class="booking-content-wrap second-row">
								...
								<div class="invo-book-detail detail-col-car1">
									<span class="font-sm-700 color-light-black">Statement For:</span>
									<span class="font-sm">2023 Spring</span>
								</div>
								<div class="invo-book-detail detail-col-car1">
							...
							<table class="invoice-table student-invoice">
								<thead>
									<tr class="invo-tb-header">
										...
										<th class="font-md color-light-black">Due Date</th>
								...
								<tbody class="invo-tb-body">
									<tr class="invo-tb-row">
										...
										<td class="font-sm">Semester Fee (2023 Spring)</td>
										<td class="font-sm">10 April 2023</td>

										<td class="font-sm">$3000.00</td>
									</tr>
									<tr class="invo-tb-row table-bg">
										<td class="font-sm">2</td>
										<td class="font-sm">Exam Fee</td>
										<td class="font-sm">10 April 2023</td>
									...
									<tr class="invo-tb-row">
										...
										<td class="font-sm">Transport Fee</td>
										<td class="font-sm">10 April 2023</td>
									...
									<tr class="invo-tb-row table-bg">
										...
										<td class="font-sm">Hostel Fee</td>
										<td class="font-sm">10 April 2023</td>
										
										<td class="font-sm">$1500.00</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="font-sm">5</td>
										<td class="font-sm">Book Fee</td>
										<td class="font-sm">10 April 2023</td>
									...
									<tr class="invo-tb-row table-bg">
										...
										<td class="font-sm">Stationary Fee</td>
										<td class="font-sm">10 April 2023</td>
										
										<td class="font-sm">$50.00</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="font-sm">7</td>
										<td class="font-sm">Other Activity Fee</td>
										<td class="font-sm">10 April 2023</td>
								...
								<table class="invo-total-table">
									<tbody>
										...
										<tr class="invo-grand-total bottom-border">
											...
											<td class="font-18-500 color-light-black text-right pt-20">$6053.40</td>
										</tr>
									</tbody>
								</table>
							</div>
