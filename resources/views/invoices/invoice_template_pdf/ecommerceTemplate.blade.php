			...
			<div class="invoice-content-wrap" id="download_section">
					...
					<div class="ecommerce-header">
						<div class="invoice-logo">
							<div class="ecommerce-img">
								<a href="ecommerce_invoice.html"><img src="{{asset('assets/invoice//images/ecommerce/logo.png')}}" alt="ecommerce-img"></a>
							</div>
						</div>
				...
				<section class="agency-service-content ecommerce-invoice-content" id="ecommerce_invoice">
					<div class="container">
						<div class="ecommerce-first-sec">
							<div class="bus-invo-no-date-wrap">
								...
								<div class="bus-invo-date">
									...
									<div class="font-md-grey color-grey pt-10">15/12/2024</div>
								</div>
							</div>
						...
						<div class="invoice-owner-conte-wrap pt-40">
							<div class="invo-to-wrap">
								<div class="invoice-to-content">
									...
									<h2 class="color-pink font-lg pt-10">Jordon Smith</h2>
									<p class="font-md-grey color-light-black pt-10">35 Roanoke Road, IN 3526, <br>North York, USA<br>Email: jordon123@mail.com</p>
								</div>
							</div>
							<div class="invo-pay-to-wrap">
								<div class="invoice-pay-content">
									<p class="font-md color-light-black">Pay To:</p>
									<h2 class="color-pink font-lg pt-10">Digital Invoico Restaurant</h2>
									<p class="font-md-grey color-light-black pt-10">4510 E Dolphine St, IN 3526<br> Hills Road, New York, USA</p>
								</div>
							</div>
						</div>
							...
							<table class="invoice-table ecommerce-table">
								...
								<tbody class="invo-tb-body">
									<tr class="invo-tb-row table-bg">
										...
										<td class="font-sm">Men Sunglasses</td>
										<td class="font-sm">$80</td>
										<td class="font-sm">1</td>
										<td class="font-sm">$80.00</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="font-sm pl-10">2</td>
										<td class="font-sm">Casual Half Shirt</td>
										<td class="font-sm">$160</td>
										<td class="font-sm">2</td>
										<td class="font-sm">$320.00</td>
									</tr>
									<tr class="invo-tb-row table-bg">
										<td class="font-sm pl-10">3</td>
										<td class="font-sm">Realme c25 Phone</td>
										<td class="font-sm">$2500</td>
										<td class="font-sm">1</td>
										<td class="font-sm">$2500.00</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="font-sm pl-10">4</td>
										<td class="font-sm">In-Ear Headphone</td>
										<td class="font-sm">$600</td>
										<td class="font-sm">1</td>
								...
								<table class="invo-total-table">
									<tbody>
										<tr>
											...
											<td class="font-md-grey color-grey text-right pr-10">$3500.00</td>
										</tr>
										<tr class="tax-row">
											<td class="font-md color-light-black">Tax <span>(18%)</span></td>
											<td class="font-md-grey color-grey text-right pr-10">$630.00</td>
										</tr>
										<tr class="disc-row bottom-border">
											<td class="font-md color-light-black">Discount</td>
											<td class="font-md-grey color-grey discount-price text-right pr-10">- $130.00</td>
										</tr>
										<tr class="invo-grand-total">
											<td class="color-pink font-18-700 pt-20">Grand Total:</td>
											<td class="font-18-500 color-light-black text-right pr-10 pt-20">$4000.00</td>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<!--Ecommerce payment detail table start here -->
						<div class="rest-payment-bill">
								...
								<table class="res-pay-table">
									<tbody>
										...
										<tr class="pay-data">
											...
											<td class="font-md-grey color-grey">15/04/2023</td>
										</tr>
										<tr class="pay-data">
										...
										<tr class="pay-data">
											...
											<td class="font-md-grey color-grey">$4000.00</td>
										</tr>
									</tbody>
								</table>
							</div>
							<div class="signature-wrap">
								...
								<h3 class="font-md-grey color-light-black">Warehouse Manager</h3>
							</div>
						</div>
						<!-- Ecommerce payment detail table end here -->
					</div>
