					...
					<div class="container">
						...
						<div class="invoice-owner-conte-wrap">
							...
							<div class="cleaning-blue-img">
								<div class="blue-img1">
									<a href="cleaning_invoice.html"><img src="{{asset('assets/invoice/images/cleaning/logo.png')}}" alt="logo"></a>
									<div class="blue-img2">	
									</div>
								</div>
							</div>
						...
						<div class="cleaning-img-bottom-sec-wrap">
							<div class="cleaning-blue-img-bottom width-70">
								...
								<div class="blue-img1-bottom">
									<img src="{{asset('assets/invoice/images/cleaning/cleaning2-img.svg')}}" alt="bg-img">
								</div>
							</div>
