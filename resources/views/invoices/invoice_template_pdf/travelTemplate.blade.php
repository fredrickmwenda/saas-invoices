			...
			<div class="invoice-content-wrap" id="download_section">
					...
					<div class="travel-logo-sec">
						<div class="travel-logo-sec-wrap">
							<div class="travel-logo">
								<a href="travel_invoice.html"><img src="{{asset('assets/invoice/images/travel/logo.png')}}" alt="logo"></a>
							</div>
				...
				<section class="agency-service-content ecommerce-invoice-content" id="travel_invoice">
					<div class="travel-bottom-sec-img">
						<img src="{{asset('assets/invoice/images/travel/green-bg.svg')}}" alt="background-img">
					</div>	
					<div class="container">
						...
						<div class="bus-detail-wrap travel-detail-wrap">
							<div class="bus-detail-col border-bottom travel">
								<div class="font-md color-light-black bus-type">Book Date:</div>
								<div class="font-md-grey color-grey">15/04/2023</div>
							</div>
							<div class="bus-detail-col border-bottom travel">
								<div class="font-md color-light-black bus-type">Tour Package ID:</div>
								<div class="font-md-grey color-grey">Dubai Special 223</div>
							</div>
							<div class="bus-detail-col seat-col">
								<div class="font-md color-light-black bus-type">Group Size:</div>
								<div class="font-md-grey color-grey">6</div>
							</div>
							<div class="bus-detail-col">
								<div class="font-md color-light-black bus-type">Day - Night:</div>
								<div class="font-md-grey color-grey">6 Days / 5 Nights</div>
							</div>
						</div>
						...
						<div class="invo-addition-wrap invo-addition-wrap-travel pt-20">
							<div class="invo-add-info-content">
								<div>
									<div>
										<span class="font-sm-700 color-light-black">Payment Type:</span>
										<span class="font-sm">Card **** **89</span>
									</div>
								...
								<table class="invo-total-table">
									<tbody>
										...
										<tr class="disc-row bottom-border">
											...
											<td class="font-md-grey color-green-photo text-right pr-10">- $1.25</td>
										</tr>
					...
					<div class="travel-bottom-sec pt-20">
						<div class="travel-bottom-sec-wrap">
							<div class="footer-img1"><img src="{{asset('assets/invoice/images/travel/footer-img1.svg')}}" alt="background-img"></div>
							<div class="footer-img2"><img src="{{asset('assets/invoice/images/travel/footer-img2.svg')}}" alt="background-img"></div>
						</div>
					</div>
				</section>
