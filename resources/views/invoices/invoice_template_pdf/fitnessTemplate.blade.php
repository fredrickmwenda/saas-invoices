			...
			<div class="invoice-content-wrap" id="download_section">
				...
				<header class="fitness-header" id="invo_header">
					<div class="fitness-header-wrap">
						<div class="fitness-logo"><a href="fitness_invoice.html"><img src="{{asset('assets/invoice//images/fitness/logo.png')}}" alt="logo"></a></div>
							...
							<div class="fitness-contact-content">
								<div class="invo-cont-wrap invo-contact-wrap">
									...
									<div class="invo-social-name">
										<a href="tel:+12345678899" class="font-18 color-white ">+1 234 567 8899</a>
									</div>
								</div>
								<div class="invo-cont-wrap">
									...
									<div class="invo-social-name">
										<a href="mailto:contact@invoice.com" class="font-18 color-white">contact@invoice.com</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="container">
						...
						<div class="rest-payment-bill-fitness">
							<div class="fitness-sec">
								<div class="payment-wrap payment-wrap-fitness width-50">
									<table class="res-pay-table">
										<tbody>
											<tr class="pay-data">
												<td class="pay-type font-md color-light-black">Payment Details:</td>
												<td class="font-md-grey color-grey">Cash</td>
											</tr>
											<tr class="pay-data">
								...
								<div class="signature-wrap-fitness width-30 pt-40">
									<div class="signature-content">
										<div class="sign-img">
											<img src="{{asset('assets/invoice//images/signature/sign.svg')}}" alt="this is signature image">
										</div>
										<p class="font-sm-500 text-center">Alex Morris</p>
										<h3 class="font-md-grey color-light-black text-center">Fitness Instructor</h3>
									</div>
								</div>
							</div>
						</div>
