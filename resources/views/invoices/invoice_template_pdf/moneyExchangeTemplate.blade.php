		...
		<div class="invoice-container">
			<div class="invoice-content-wrap" id="download_section">
				...
				<section class="money-exchange-content" id="money_exchange">
					<div class="container">
						<!--Header start here -->
						<header class="invoice-header money-header" id="invo_header">
							<div class="invoice-logo-content">
								<div class="invoice-logo">
									<a href="money_exchange.html" class="logo"><img src="{{asset('assets/invoice/images/money/logo.png')}}" alt="this is a invoice logo"></a>
								</div>
								<div class="money-img">
									<h1 class="money-txt">INVOICE</h1>
								</div>
							</div>
							<div class="money-boder-sec pt-20">
								<div class="black-boder"></div>
								<div class="green-boder"></div>
							</div>
						</header>
						<!--Header end here -->
						...
						<div class="invoice-owner-conte-wrap pt-40">
							<div class="invo-to-wrap">
								<div class="invoice-to-content">
									<p class="font-md color-light-black">Send To:</p>
									<h2 class="font-lg color-green pt-10">Jordon Smith</h2>
									<p class="font-md-grey color-grey pt-10">Phone: +1 562 563 8899 <br> Email: jordon123@mail.com
										<br> Country: USA
									</p>
								</div>
							</div>
							<div class="invo-pay-to-wrap">
								<div class="invoice-pay-content">
									...
									<h2 class="font-lg color-green pt-10">Digital Invoico Exchange</h2>
									<p class="font-md-grey color-grey pt-10">4510 E Dolphine St, IN 3526<br> Hills Road, New York, USA</p>
								</div>
							</div>
						</div>
						<!--Invoice owner name end here -->
						<!--Money exchange detail start here -->
						<div class="bus-detail-wrap money-detail-wrap table-bg">
							<div class="bus-detail-col border-bottom">
								<div class="bus-type font-md color-light-black">Funded Date:</div>
								<div class="font-md-grey color-grey">30/11/2022</div>
							</div>
							<div class="bus-detail-col border-bottom">
								<div class="bus-type font-md color-light-black">Transection No:</div>
								<div class="font-md-grey color-grey">TN75623</div>
							</div>
							<div class="bus-detail-col seat-col">
								<div class="bus-type font-md color-light-black">Paid Out Date:</div>
								<div class="font-md-grey color-grey">2/12/2022</div>
							</div>
							<div class="bus-detail-col">
								<div class="bus-type font-md color-light-black">Membership:</div>
								<div class="font-md-grey color-grey">DIE23456A</div>
							</div>
						</div>
						<!--Money exchange detail end here -->
						<!--Transfer overview content start here -->
						<div class="transfer-wrap pt-40">
							<div class="money-tran-title-wrap">
								<h3 class="font-lg color-green transfer-title">Transfer Overview</h3>
							</div>
							<div class="transfer-detail-wrap">
								<div class="left-money-transfer">
									<div class="left-money-top-row">
										<div class="tra-amount-paid tra-left-row-content">
											<span class="font-sm-500 tra-title">Amount Paid by Jordon</span>
											<p class="font-md-500 tra-money">$5000.00 USD</p>
										</div>
										<div class="tra-amount-paid">
											<span class="font-sm-500 tra-title">Amount converted</span>
											<p class="font-md-500 tra-money">$6700.00 CAD</p>
										</div>
									</div>
									<div class="left-money-bottom-row">
										<div class="tra-amount-paid tra-left-row-content">
											<span class="font-sm-500 tra-title">Fee</span>
											<p class="font-md-500 tra-money">$10.50 USD Per $1000 USD</p>
										</div>
										<div class="tra-amount-paid">
											<span class="font-sm-500 tra-title">Converted and send to</span>
											<p class="font-md-500 tra-money">$6643.72 CAD</p>
										</div>
									</div>
								</div>
								<div class="right-money-transfer bg-dark-green">
									<h4 class="font-md color-white mon-exchange-rate">Exchange rate:</h4>
									<div class="right-money-block">
										<div class="money-col-one">
											<span class="font-md-grey money-content">1</span>
											<span class="font-md-grey money-content">usd</span>
										</div>
										<div class="money-col-two b-text">=</div>
										<div class="money-col-three">
											<span class="font-md-grey money-content">1.34</span>
											<span class="font-md-grey money-content">cad</span>
										</div>
									</div>
								</div>
							</div>
						</div>
						<!--Transfer overview content end here -->
						<!--Send to content start here -->
						<div class="money-send-title-wrap pt-40">
							<h3 class="font-lg color-green transfer-title">Send To</h3>
							<div class="mon-sent-content-wrap">
								<div class="mon-send-left-data">
									<div class="mon-send-col-one">
										<span class="font-sm-500 color-light-black">Account Name:</span>
										<span class="font-sm">Alex Smith</span>
									</div>
									<div class="mon-send-col-one">
										<span class="font-sm-500 color-light-black">Bank Name & Branch:</span>
										<span class="font-sm">Toronto Bank</span>
									</div>
									<div class="mon-send-col-one">
										<span class="font-sm-500 color-light-black">Reference:</span>
										<span class="font-sm">56231489</span>
									</div>
								</div>
								<div class="mon-send-right-data">
									...
									<div class="mon-send-col-two">
										<span class="font-sm-500 color-light-black">SWIFT / BIC Code:</span>
										<span class="font-sm">CR569874JR36</span>
									</div>
									<div class="mon-send-col-two">
										<span class="font-sm-500 color-light-black">Address:</span>
										<span class="font-sm">2 Honk Road, Ontario, Canada</span>
									</div>
								</div>
							</div>
						</div>
						<!--Send to content end here -->
						<!--Paid Out content start here -->
						<div class="paid-out-title-wrap pt-40">
							<h3 class="font-lg color-green transfer-title">Paid Out From</h3>
							<div class="mon-sent-content-wrap">
								<div class="mon-paid-left-data">
									<div class="mon-send-col-one">
										<span class="font-sm-500 color-light-black">Account Name:</span>
										<span class="font-sm">Digital Invoico Exchange</span>
									</div>
									<div class="mon-send-col-one">
										<span class="font-sm-500 color-light-black">Bank Name & Branch:</span>
										<span class="font-sm">Toronto Bank</span>
								...
								<div class="mon-send-right-data">
									<div class="mon-send-col-two">
										<span class="font-sm-500 color-light-black">Reference:</span>
										<span class="font-sm">56145623</span>
									</div>
									<div class="mon-send-col-two">
										<span class="font-sm-500 color-light-black">Delivered:</span>
										<span class="font-sm">Bank Transfer</span>
									</div>
								</div>
							</div>
						</div>
						<!--Paid Out content end here -->
					</div>
						...
						<div class="invoice-header-contact">
							<div class="invo-cont-wrap invo-contact-wrap">
								<div class="invo-social-icon">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_6_94)"><path d="M5 4H9L11 9L8.5 10.5C9.57096 12.6715 11.3285 14.429 13.5 15.5L15 13L20 15V19C20 19.5304 19.7893 20.0391 19.4142 20.4142C19.0391 20.7893 18.5304 21 18 21C14.0993 20.763 10.4202 19.1065 7.65683 16.3432C4.8935 13.5798 3.23705 9.90074 3 6C3 5.46957 3.21071 4.96086 3.58579 4.58579C3.96086 4.21071 4.46957 4 5 4" stroke="#60A917" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M15 7C15.5304 7 16.0391 7.21071 16.4142 7.58579C16.7893 7.96086 17 8.46957 17 9" stroke="#60A917" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M15 3C16.5913 3 18.1174 3.63214 19.2426 4.75736C20.3679 5.88258 21 7.4087 21 9" stroke="#60A917" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></g><defs><clipPath id="clip0_6_94"><rect width="24" height="24" fill="#60A917"></rect></clipPath></defs></svg>
								</div>
							...
							<div class="invo-cont-wrap">
								<div class="invo-social-icon">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_6_108)"><path d="M19 5H5C3.89543 5 3 5.89543 3 7V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V7C21 5.89543 20.1046 5 19 5Z" stroke="#60A917" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M3 7L12 13L21 7" stroke="#60A917" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></g><defs><clipPath id="clip0_6_108"><rect width="24" height="24" fill="#60A917"></rect></clipPath></defs></svg>
								</div>
								<div class="invo-social-name">
