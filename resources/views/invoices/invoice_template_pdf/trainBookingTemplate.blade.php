				...
				<header class="train-header" id="invo_header">
					<div class="invoice-logo-content">
						<div class="invoice-logo">
							<div>
								<a href="train_booking.html" class="logo"><img src="{{asset('assets/invoice/images/train/logo.png')}}" alt="this is a invoice logo"></a>
							</div>
							<div class="invoice-header-contact pt-30">
						...
						<div class="invoice-owner-conte-wrap">
							...
							<div class="invo-pay-to-wrap width-50">
								<div class="movie-detail-col train-detail-col border-bottom table-bg">
									<div class="font-md color-light-black w-40 text-left">From:</div>
									<div class="font-md-grey color-grey" >Hills St</div>
								</div>
								<div class="movie-detail-col border-bottom  train-detail-col">
									<div class="font-md color-light-black w-40 text-left">To:</div>
									<div class="font-md-grey color-grey" >Arona St</div>
								</div>
								<div class="movie-detail-col border-bottom table-bg train-detail-col train-detail-col">
									<div class="font-md color-light-black w-40 text-left">Journey Date:</div>
									<div class="font-md-grey color-grey" >24 April 2023</div>
								</div>
								<div class="movie-detail-col border-bottom train-detail-col">
									<div class="font-md color-light-black w-40 text-left">Seat No:</div>
									<div class="font-md-grey color-grey" >30, 31</div>
								</div>
							</div>
						</div>
							...
							<div class="mon-sent-content-wrap">
								...
								<div class="mon-send-right-data">
									<div class="mon-send-col-two">
										<span class="font-sm-500 color-light-black">PNR Number:</span>
										<span class="font-sm color-grey">TB12344</span>
									</div>
									<div class="mon-send-col-two">
										<span class="font-sm-500 color-light-black">Platform No:</span>
										<span class="font-sm color-grey">2</span>
									</div>
									<div class="mon-send-col-two">
										<span class="font-sm-500 color-light-black">Class:</span>
										<span class="font-sm color-grey">AC Chair</span>
									</div>
									<div class="mon-send-col-two">
										<span class="font-sm-500 color-light-black">Ticket Number:</span>
										<span class="font-sm color-grey">#SM75692</span>
									</div>
									<div class="mon-send-col-two">
										<span class="font-sm-500 color-light-black">Child:</span>
										<span class="font-sm color-grey">0</span>
									</div>
								</div>
							</div>
						</div>
