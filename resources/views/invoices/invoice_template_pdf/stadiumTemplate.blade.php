		...
		<div class="invoice-container">
			<div class="invoice-content-wrap" id="download_section">
				...
				<header class="stadium-header" id="invo_header">
					<div class="invoice-logo-content">
						<div class="invoice-logo width-30">
							<a href="stadium_invoice.html" class="logo-stadium"><img src="{{asset('assets/invoice/images/stadium/logo.png')}}" alt="this is a invoice logo"></a>
						</div>
						<div class="stadium-title width-70">
							<h1 class="stadium-title-txt">INVOICE</h1>
						</div>
					</div>
				</header>
				<!--Header end Here -->
				...
				<section class="ticket-booking-content" id="ticket_booking">
					<div class="container">
						<div class="stadium-first pt-40">
							<div class="stadium-first-sec">
								...
								<div class="stadium-second pt-40 ">
									<div class="stadium-second-left">
										<div>
											<div class="invo-cont-wrap invo-contact-wrap">
												...
												<div class="invo-social-name">
													<a href="tel:+12345678899" class="font-md-grey color-light-black">+1 234 567 8899</a>
												</div>
											</div>
											<div class="invo-cont-wrap pt-10">
												...
												<div class="invo-social-name">
													<a href="mailto:contact@invoice.com" class="font-md-grey color-light-black">contact@invoice.com</a>
												</div>
											</div>
											<p class="font-md-grey color-grey pt-15">4510 E Dolphine St, IN 3526 Hills Road, New York, USA</p>
										</div>
										<div class="movie-must-title pt-40">
							...
							<div class="stadium-second-sec">
								<div class="stadium-second-sec-full">
									<div class="stadium-table">
										<div class="font-md color-light-black">Book Date:</div>
										<div class="font-md-grey color-grey">30/11/2022</div>
									</div>
									<div class="stadium-table">
										<div class="font-md color-light-black">Block No:</div>
										<div class="font-md-grey color-grey">135</div>
									</div>
									<div class="stadium-table">
										<div class="font-md color-light-black pt-10">Gate No:</div>
										<div class="font-md-grey color-grey pt-10">D2</div>
									</div><div class="stadium-table">
										<div class="font-md color-light-black pt-10">Seat No:</div>
										<div class="font-md-grey color-grey pt-10">454, 455</div>
									</div>
								</div>
								<div class="booker-info pt-40">
									<h2 class="book-txt transfer-title">Booker Information:</h2>
									<table class="book-table">
										<thead>
											<tr class="invo-tb-header">
												<th class="font-md color-light-black qty-wid">S No.</th>
												<th class="font-md color-light-black wid-26">Name</th>
												<th class="font-md color-light-black re-qty-wid">Age</th>
												<th class="font-md color-light-black re-qty-wid">Gender</th>
											</tr>
										</thead>
										<tbody class="invo-tb-body">
											<tr class="invo-tb-row">
												<td class="font-sm">1</td>
												<td class="font-sm">Jordon Smith</td>
												<td class="font-sm ">25 Y</td>
												<td class="font-sm">M</td>
											</tr>
											<tr class="invo-tb-row">
												<td class="font-sm">2</td>
												<td class="font-sm">Clara Smith</td>
												<td class="font-sm ">23 Y</td>
												<td class="font-sm ">F</td>
											</tr>
										</tbody>
									</table>
								</div>
								<div class="ticket-price pt-40">
									<h2 class="book-txt transfer-title">Ticket Price:</h2>
									<table class="price-table">
										...
										<tbody class="invo-tb-body">
											<tr class="invo-tb-row">
												<td class="font-sm">General - 2 Seats</td>
												<td class="font-sm">$80.00</td>
												<td class="font-sm ">2</td>
												<td class="font-sm">$160.00</td>
											</tr>
										</tbody>
									</table>
								</div>
								<div class="stadium-table-total-wrap">
									<table class="invo-total-table stadium-table-total">
										<tbody>
											<tr>
												<td class="font-md color-light-black pt-20">Sub Total:</td>
												<td class="font-md-grey color-grey text-right pt-20">$160.00</td>
											</tr>
											<tr class="tax-row bottom-border">
												<td class="font-md color-light-black">Tax <span class="color-grey ">(18%)</span></td>
												<td class="font-md-grey color-grey text-right">$18.80</td>
											</tr>
											<tr class="invo-grand-total">
												<td class="color-green font-lg pt-20">Grand Total:</td>
												<td class="font-18-500 color-light-black  text-right pt-20">$188.80</td>
											</tr>
										</tbody>
									</table>
								</div>
