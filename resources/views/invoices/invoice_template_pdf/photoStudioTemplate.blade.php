			...
			<div class="invoice-content-wrap" id="download_section">
					...
					<div class="invoice-logo-content">
						<div class="invo-head-content">
							<div class="phtotstudio-img">
								<img src="{{asset('assets/invoice/images/photostudio/header-img.svg')}}" alt="phtotstudio-img" class="photo-header-img">
								<a href="photostudio_invoice.html"><img src="{{asset('assets/invoice/images/photostudio/logo.png')}}" alt="phtotstudio-img" class="photo-logo"></a>
							</div>
						</div>
					</div>
				</header> 
				...
				<section class="photo-invoice-details" id="photostudio_invoice">
					<div class="container">
						...
						<!--PhotoStudio detail start here -->
						<div class="bus-detail-wrap photostudio-detail-wrap mt-30">
							<div class="bus-detail-col border-bottom">
								<div class="font-md color-light-black bus-type">Payment Details:</div>
								<div class="font-md-grey color-grey">Cash</div>
							</div>
							<div class="bus-detail-col border-bottom">
								<div class="font-md color-light-black bus-type">Transaction ID:</div>
								<div class="font-md-grey color-grey">TD23651456</div>
							</div>
							<div class="bus-detail-col seat-col">
								<div class="font-md color-light-black bus-type">Date:</div>
								<div class="font-md-grey color-grey">15/04/2023</div>
							</div>
							<div class="bus-detail-col">
								<div class="font-md color-light-black bus-type">Amount</div>
								<div class="font-md-grey color-grey">$1260.00</div>
							</div>
						</div>
						<!--PhotoStudio detail end here -->
						<div class="photostudio-contact pt-40">
							<div>
					...
					<div class="photo-footer-sec">
						<div class="photo-footer-sec-img">
							<img src="{{asset('assets/invoice/images/photostudio/footer-img.svg')}}" alt="phtotstudio-footer-img">
						</div>
					</div>
				</section>
