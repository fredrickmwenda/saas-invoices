				...
				<header class="invoice-header hospital-header bg-black" id="invo_header">
					<div class="invoice-logo-content">
						<div class="invoice-logo">
							<a href="hospital_invoice.html" class="logo"><img src="{{asset('assets/invoice//images/hospital/logo.png')}}" alt="this is a invoice logo"></a>
						</div>
					</div>
				</header>
				<!--Header end here -->
					...
					<div class="container">
						...
						<div class="hospital-contact-wrap">
							<div class="hospital-contact">
								<div class="pt-20 hospital-contact-details">
								...
								<div class="invo-cont-wrap invo-contact-wrap pt-20">
									<div class="invo-social-icon">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											<g clip-path="url(#clip0_31_653)">
												<path d="M3 21H21" stroke="#12151C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
												<path d="M5 21V5C5 4.46957 5.21071 3.96086 5.58579 3.58579C5.96086 3.21071 6.46957 3 7 3H17C17.5304 3 18.0391 3.21071 18.4142 3.58579C18.7893 3.96086 19 4.46957 19 5V21" stroke="#12151C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
												<path d="M9 21V17C9 16.4696 9.21071 15.9609 9.58579 15.5858C9.96086 15.2107 10.4696 15 11 15H13C13.5304 15 14.0391 15.2107 14.4142 15.5858C14.7893 15.9609 15 16.4696 15 17V21" stroke="#12151C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
												<path d="M10 9H14" stroke="#12151C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
												<path d="M12 7V11" stroke="#12151C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
											</g>
											<defs>
									...
									<div class="invo-social-name">
										<p class="font-md-grey color-grey">4510 E Dolphine St, IN 3526 Hills Road, New York, USA</p>
									</div>
								</div>
							</div>
						...
						<div class="invoice-owner-conte-wrap pt-40">
							<div class="invo-to-wrap width-70">
								<div class="invoice-to-content">
									<p class="font-md color-light-black">Patient Info:</p>
									<h2 class="color-green-hospital font-lg pt-10">Jordon Smith</h2>
									<p class="font-md-grey color-grey pt-10">Phone: +1 562 563 8899 <br> Bad No: G5</p>
								</div>
							</div>
						...
						<div class="payment-table-wrap hospital-table-wrap">
							...
							<table class="invoice-table hospital-table">
								...
								<tbody class="invo-tb-body">
									<tr class="invo-tb-row">
										<td class="invo-tb-data font-sm">1</td>
										<td class="invo-tb-data rate-data font-sm">All Blood Test</td>
										<td class="invo-tb-data rate-data font-sm">$200.00</td>
										<td class="invo-tb-data total-data font-sm text-right pr-10">$200.00</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="invo-tb-data font-sm">2</td>
										<td class="invo-tb-data rate-data font-sm">Sugar Test</td>
										<td class="invo-tb-data rate-data font-sm">$40.00</td>
										<td class="invo-tb-data total-data font-sm text-right pr-10">$40.00</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="invo-tb-data font-sm">3</td>
										<td class="invo-tb-data rate-data font-sm">Surgeon Fee</td>
										<td class="invo-tb-data rate-data font-sm">$60.00</td>
										<td class="invo-tb-data total-data font-sm text-right pr-10">$60.00</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="invo-tb-data font-sm">4</td>
										<td class="invo-tb-data rate-data font-sm">Medical Medicine Bill</td>
										<td class="invo-tb-data rate-data font-sm">$125.00</td>
										<td class="invo-tb-data total-data font-sm text-right pr-10">$125.00</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="invo-tb-data font-sm">5</td>
										<td class="invo-tb-data rate-data font-sm">Hospital Usage Bill</td>
										<td class="invo-tb-data rate-data font-sm">$80.00</td>
										<td class="invo-tb-data total-data font-sm text-right pr-10">$80.00</td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div class="invo-addition-wrap pt-20 hospital-rule">
							<div class="invo-add-info-content bus-term-cond-content">
								<h3 class="addi-info-title font-md color-light-black">Hospital Rules:</h3>
								<div class="term-condi-list pt-10">
									<ul class="term-con-list">
										...
										<li class="font-sm">Et rhoncus suspendisse eget habitant vitae vel in.</li>
										<li class="font-sm">A vulputate bibendum id tristique convallis eleifend lobortis nunc enim.</li>
									</ul>
								</div>
							</div>
								...
								<table class="invo-total-table ">
									<tbody>
										<tr>
											...
											<td class="font-md-grey color-grey text-right pr-10">$505.00</td>
										</tr>
										<tr class="tax-row bottom-border">
											<td class="font-md color-light-black  ">Tax <span class="color-grey">(18%)</span></td>
											<td class="font-md-grey color-grey text-right pr-10">$90.90</td>
										</tr>
										<tr class="invo-grand-total">
											<td class="color-green-hospital  font-18-700 pt-20">Grand Total:</td>
											<td class="font-18-500 color-light-black text-right pr-10 pt-20">$595.90</td>
										</tr>
									</tbody>
								</table>
							</div>
