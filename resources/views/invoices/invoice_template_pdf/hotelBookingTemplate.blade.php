				...
				<header class="hotel-header" id="invo_header">
					<div class="invoice-logo-content pink-bg">
						<div class="invoice-logo invoice-logo-hotel">
							<a href="hotel_booking.html" class="logo"><img src="{{asset('assets/invoice/images/hotel/logo.png')}}" alt="this is a invoice logo"></a>
						</div>
						<div class="invo-head-content invoice-logo-hotel-left ">
							<img src="{{asset('assets/invoice/images/hotel/txt-img.png')}}" class="txt-img" alt="txt-img">
							<div class="invo-head-wrap">
								<div class="color-white font-md wid-40-hotel">Invoice No:</div>
								<div class="font-md-grey color-white wid-20">#DI56789</div>
							</div>
							<div class="invo-head-wrap invoi-date-wrap invoi-date-wrap-agency">
								...
								<div class="font-md-grey color-white wid-20">15/12/2024</div>
							</div>
						</div>
					</div>
				</header> 
					...
					<div class="container">
						...
						<div class="invoice-owner-conte-wrap pt-20">
							<div class="invo-to-wrap">
								<div class="invoice-to-content">
									<p class="font-md color-light-black">Guest Info:</p>
									<h1 class="font-lg color-purple pt-10">Jordon Smith</h1>
							...
							<div class="invo-pay-to-wrap">
								<div class="invoice-pay-content">
									<p class="font-md color-light-black">Hotel Details:</p>
									<h2 class="font-lg color-purple pt-10">Digital Invoico Star Hotel</h2>
						...
						<div class="invo-hotel-book-wrap pt-40">
							<div class="booking-content-wrap">
								<div class="invo-book-detail detail-col">
									<span class="font-sm-700 color-light-black ">Booking ID:</span>
									<span class="font-sm">DIH56321</span>
								</div>
								<div class="invo-book-detail detail-col">
									<span class="font-sm-700 color-light-black ">Check In:</span>
									<span class="font-sm">30/11/2022</span>
								</div>
								<div class="invo-book-detail detail-col">
									<span class="font-sm-700 color-light-black">Nights:</span>
									<span class="font-sm">3</span>
								</div>
							</div>
							<div class="booking-content-wrap second-row">
								<div class="invo-book-detail detail-col">
									<span class="font-sm-700 color-light-black">Room No:</span>
									<span class="font-sm">101</span>
								</div>
								<div class="invo-book-detail detail-col">
									<span class="font-sm-700 color-light-black">Check Out:</span>
									<span class="font-sm">02/12/2022</span>
								</div>
								<div class="invo-book-detail detail-col">
									<span class="font-sm-700 color-light-black">Room Type: </span>
							...
							<table class="invoice-table hotel-table">
								...
								<tbody class="invo-tb-body">
									<tr class="invo-tb-row">
										<td class="font-sm pl-10">Delux Room</td>
										<td class="font-sm">Double bedroom with private bathroom</td>
										<td class="font-sm text-center">1 Rooms x 3 Nights x $300.00</td>
										<td class="font-sm text-right">$900.00</td>
									</tr>
									<tr class="invo-tb-row table-bg">
										<td class="font-sm pl-10">Room Service</td>
										<td class="font-sm">Breakfast + Dinner</td>
										<td class="font-sm text-center">$30.00 X One Time</td>
										<td class="font-sm text-right">$180.00</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="font-sm pl-10">Promotional Code</td>
										<td class="font-sm">HOLYSUMMER - One Time Discount</td>
										<td class="font-sm text-center ">20% OFF</td>
										<td class="font-sm text-right">-$216.00</td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div class="payment-table-wrap hotel-booking-wrap">
							<table class="invo-payment-table">
								<thead>
									<tr class="invo-tb-header">
										<th class="font-md color-light-black payemnt-wid">Payment Details</th>
										<th class="font-md color-light-black date-wid">Date</th>
										<th class="font-md color-light-black trans-wid">Transaction ID</th>
										<th class="font-md color-light-black amount-wid text-right">Amount</th>
									</tr>
								</thead>
								<tbody>
									<tr class="invo-paye-row">
										<td class="font-sm payment-desc second-color">American Express</td>
										<td class="font-sm payment-desc second-color">25/11/2022</td>
										<td class="font-sm payment-desc second-color">TD52369815</td>
										<td class="font-sm payment-desc second-color text-right">$1019.52</td>
									</tr>
								</tbody>
							</table>
						</div>
