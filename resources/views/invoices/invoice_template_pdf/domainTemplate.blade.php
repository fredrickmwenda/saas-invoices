...
<head>
	...
	<link rel="stylesheet" href="{{asset('assets/invoice/custom.css')}}">
	<link rel="stylesheet" href="{{asset('assets/invoice/media-query.css')}}">
</head>
<body>
				...
				<header class="domain-header" id="invo_header">
					<div class="invoice-logo-content invoice-logo-content-domain">
						<div class="invoice-logo invoice-logo-domain">
							<a href="domain_invoice.html"><img src="{{asset('assets/invoice/images/domain/logo.png')}}" alt="logo"></a>
						</div>
