...
<div>
        ...
        <div class="card-body p-4">
            <div class="d-flex justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center">
                    <a href="user-profile.html#" class="btn btn-outline-light text-body fw-medium fs-16 px-4 hover hover-bg">
                        <i class="ri-edit-line fw-medium fs-18 me-1"></i>
                        <span>Edit</span>
                    </a>
                    <a href="user-profile.html#" class="btn btn-primary fw-medium fs-16 px-4 ms-3">
                        <i class="ri-receipt-fill fw-medium fs-18 me-1"></i>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-2 mb-4">
        <a href="user-profile.html" class="btn btn-primary py-2 px-3 fw-medium">Profile</a>
        <a href="teams-2.html" class="btn btn-outline-primary py-2 px-3 fw-medium">Team</a>
        <a href="my-projects.html" class="btn btn-outline-primary py-2 px-3 fw-medium">Projects</a>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="ps-0 mb-0 list-unstyled d-flex align-items-center">
                                        <li>
                                            <a href="my-profile.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Alex">
                                                <img src="assets/images/user-16.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                            </a>
                                        </li>
                                        <li class="ms-m-15">
                                            <a href="my-profile.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Juhon">
                                                <img src="assets/images/user-17.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                            </a>
                                        </li>
                                        <li class="ms-m-15">
                                            <a href="my-profile.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Staven">
                                                <img src="assets/images/user-18.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                            </a>
                                        </li>
                                        <li class="ms-m-15">
                                            <a href="my-profile.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Pew Smith">
                                                <img src="assets/images/user-19.jpg" class="wh-34 lh-34 rounded-circle border border-1 border-color-white" alt="user">
                                            </a>
                                        </li>
                                        <li class="ms-m-15">
                                            <a href="https://templates.envytheme.com/trezo/user-list.html" class="wh-34 lh-34 rounded-circle bg-primary d-block text-center text-decoration-none text-white fs-12 fw-medium border border-1 border-color-white">+10</a>
                                        </li>
                                    </ul>
                                </td>
                    ...
                    <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination mb-0 justify-content-center">
                                <li class="page-item">
                                    <a class="page-link icon" href="team-members.html" aria-label="Previous">
                                        <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                    </a>
                                </li>
                                <li class="page-item"><a class="page-link active" href="team-members.html">1</a></li>
                                <li class="page-item"><a class="page-link" href="team-members.html">2</a></li>
                                <li class="page-item"><a class="page-link" href="team-members.html">3</a></li>
                                <li class="page-item"><a class="page-link" href="team-members.html">4</a></li>
                                <li class="page-item">
                                    <a class="page-link icon" href="team-members.html" aria-label="Next">
