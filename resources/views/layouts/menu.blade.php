@role('admin')
 ...
 <!-- Additional Blog -->
    ...
    <li class="nav-item {{ Request::is('admin/categories*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('tags.index') }}">
            <span class="menu-icon">
                <i class="fa-solid fas fa-th-list pe-3"></i>
            </span>
            <span class="aside-menu-title">{{ __('Tags') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item {{ Request::is('admin/services*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('services.index') }}">
            ...
            <span class="aside-menu-title">{{ 'Services' }}</span>
        </a>
    </li>
