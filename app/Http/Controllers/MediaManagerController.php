...
class MediaManagerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (FacadesAuth::user()->user_type != 'admin') {
            $mediaFiles = $mediaFiles->where('user_id', FacadesAuth::user()->id);
        }
        ...
        return [
            'status' => true,
            'recentFiles' => view('media-manager.recent', compact('recentFiles'))->render(),
            'mediaFiles' => view('media-manager.previous', compact('mediaFiles'))->render(),
    ...
    public function selectedFiles(Request $request)
    {
        ...
        return [
            'status' => true,
            'mediaFiles' => view('media-manager.image', compact('mediaFiles'))->render()
        ];
    }
    ...
    public function store(Request $request)
    {
        if ($request->hasFile('media_file')) {
            ...
            $mediaFile->user_id = FacadesAuth::user()->id;
